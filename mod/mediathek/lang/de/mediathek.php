...
/**
 * Strings for component 'mediathek', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod
...
$string['configrequiremodintro'] = 'Deaktivieren Sie diese Option, wenn Sie nicht wünschen, dass die Benutzer gezwungen werden, eine Beschreibung für jede Aktivität einzugeben.';
...
$string['externalurl'] = 'Link zum Medium';
...
$string['modulename'] = 'Mediathek';
$string['modulenameplural'] = 'Mediathek';
$string['neverseen'] = 'Nie gesehen';
$string['optionsheader'] = 'Optionen';
$string['page-mod-mediathek-x'] = 'Jede Mediathek-Seite';
...
$string['mediathek:view'] = 'URL sehen';
