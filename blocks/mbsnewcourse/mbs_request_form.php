...
/**
 * block_mbsnewcourse course request form
 * 
...
class mbs_course_request_form extends moodleform {
    ...
    public function definition() {
        ...
        if ($schoolcategory = \local_mbs\local\schoolcategory::get_schoolcategory($requestcategory->id)) {
            ...
            $mform->addElement('static', 'schoolcategory', get_string('schoolcategory', 'block_mbsnewcourse'), $link);
        }
        ...
        $mform->addElement('select', 'category', get_string('requestcategory', 'block_mbsnewcourse'), $categories);
        $mform->setDefault('category', $requestcategory->id);
        $mform->addHelpButton('category', 'requestcategory', 'block_mbsnewcourse');

        // Approvers.
        $renderer = $PAGE->get_renderer('block_mbsnewcourse');
        $approvers = $renderer->render_approvers_list($requestcategory->id);
        $mform->addElement('static', 'approvers', get_string('approvers', 'block_mbsnewcourse'), $approvers);
        ...
        $mform->addElement('header', 'requestreason', get_string('courserequestreason', 'block_mbsnewcourse'));

        $mform->addElement('textarea', 'reason', get_string('courserequestsupport', 'block_mbsnewcourse'), array('rows' => '15', 'cols' => '50'));
