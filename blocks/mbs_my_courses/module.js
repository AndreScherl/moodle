M.block_mbs_my_courses = {}

M.block_mbs_my_courses.add_handles = function(Y) {
    M.block_mbs_my_courses.Y = Y;
    var MOVEICON = {
        pix: "i/move_2d",
        component: 'moodle'
    };
    ...
    YUI().use('dd-constrain', 'dd-proxy', 'dd-drop', 'dd-plugin', function(Y) {
        ...
        Y.DD.DDM.on('drag:start', function(e) {
            ...
            drag.get('dragNode').addClass('block_mbs_my_courses');
...
M.block_mbs_my_courses.save = function() {
    var Y = M.block_mbs_my_courses.Y;
    ...
    Y.io(M.cfg.wwwroot+'/blocks/mbs_my_courses/save.php', {
        method: 'POST',
 ...
 */
M.block_mbs_my_courses.collapsible = function(Y, id, userpref, strtooltip) {
    if (userpref) {
        M.block_mbs_my_courses.userpref = true;
    }
    Y.use('anim', function(Y) {
        new M.block_mbs_my_courses.CollapsibleRegion(Y, id, userpref, strtooltip);
    });
};
 ...
 * @param {String} strtooltip
 */
M.block_mbs_my_courses.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
...
M.block_mbs_my_courses.userpref = false;
 ...
 * @type String
 */
M.block_mbs_my_courses.CollapsibleRegion.prototype.userpref = null;
 ...
 * @type Y.Node
 */
M.block_mbs_my_courses.CollapsibleRegion.prototype.div = null;
 ...
 * @type Y.Node
 */
M.block_mbs_my_courses.CollapsibleRegion.prototype.icon = null;
