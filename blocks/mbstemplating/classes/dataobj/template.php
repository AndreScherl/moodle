...
/**
 * Class template
 * For block_mbstemplating_template.
 * @package block_mbstemplating
 */
namespace block_mbstemplating\dataobj;
...
class template extends \data_object {
    ...
    public $table = 'block_mbstemplating_template';
    ...
    public static function fetch($params) {
        return self::fetch_helper('block_mbstemplating_template', __CLASS__, $params);
    }
}