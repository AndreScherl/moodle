...
/**
 * language definitions for block_mbs_schooltitle
 *
...
$string['mbs_schooltitle:addinstance'] = 'Add mebis school title';
$string['mbs_schooltitle:edittitle'] = 'Edit the title for a school';
