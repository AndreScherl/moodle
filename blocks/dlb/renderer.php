 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_dlb_renderer extends plugin_renderer_base {
    /**
     ...
     */
    public function navigation_tree($navigation, $expansionlimit, array $options = array()) {
        
        $content = $this->navigation_node($navigation, array('class'=>'block_tree list'), $expansionlimit, $options);
    ...
    protected function navigation_node($items, $attrs=array(), $expansionlimit=null, array $options = array(), $depth=1) {
        ...
        foreach ($items as $item) {
            ...
            if ($depth > 1) $liclasses = array($item->get_css_type(), 'depth_'.$depth);
            $liexpandable = array();
