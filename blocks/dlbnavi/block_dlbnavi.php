 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_dlbnavi extends block_base {
    ...
    function get_required_javascript() {
        ...
        $this->page->requires->yui_module(array('core_dock', 'moodle-block_dlbnavi-navigation'), 'M.block_dlbnavi.init_add_tree', array($arguments));
    }
    ...
    function get_content() {
        ...
        $renderer = $this->page->get_renderer('block_dlbnavi');
