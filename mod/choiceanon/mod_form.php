...
//-------------------------------------------------------------------------------
        ...
        $mform->addElement('select', 'display', get_string("displaymode","choice"), $CHOICEANON_DISPLAY);
//-------------------------------------------------------------------------------
        ...
        $repeatarray = array();
        $repeatarray[] = $mform->createElement('text', 'option', get_string('optionno', 'choiceanon'));
        $repeatarray[] = $mform->createElement('text', 'limit', get_string('limitno', 'choiceanon'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->addElement('select', 'publish', get_string("privacy", "choice"), $CHOICEANON_PUBLISH);
