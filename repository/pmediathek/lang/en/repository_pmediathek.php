...
$string['cannotview'] = 'Cannot view';
$string['cannotview_help'] = 'You will need to visit the external Prüfungsarchiv system in order to view this file.';
$string['clearcache'] = 'Clear search parameter cache';
...
$string['pmediathek:view'] = 'View Prüfungsarchiv repository';
$string['mediatype'] = 'Media type';
$string['password'] = 'Mediathek server password';
...
$string['textsearch'] = 'Text search';
$string['title'] = 'Title';
$string['topiclist'] = 'Topic';
$string['type'] = 'Type';
$string['type_analysis'] = 'Analysis';
$string['type_diagnosis'] = 'Diagnosis';
$string['type_example'] = 'Example';
$string['type_listening'] = 'Listening';
$string['type_oral'] = 'Oral';
$string['type_packet'] = 'Packet';
$string['type_picture'] = 'Picture';
$string['type_result'] = 'Result';
$string['type_sheetmusic'] = 'Sheet music';
$string['type_solution'] = 'Solution';
$string['type_task'] = 'Task';
$string['type_text'] = 'Text';
$string['type_writing'] = 'Writing';
$string['typicalage'] = 'Typical learner age: {$a} years';
$string['url'] = 'Mediathek server URL';
$string['username'] = 'Mediathek server username';
$string['view'] = 'View';
$string['year'] = 'Year';
