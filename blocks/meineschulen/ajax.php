...
case 'schoolsearch':
    ...
    $resp = (object)array(
        'error' => 0,
        'results' => meineschulen::output_school_search_results($searchtext, $schooltype, $sortby, $sortdir, $numberofresults,
...
case 'blockschoolsearch':
    ...
    $resp = (object)array(
        'error' => 0,
        'results' => meineschulen::output_block_school_search_results($searchtext, $schooltype, $sortby, $sortdir, $numberofresults,
                                                                      $page, $searchtype),
    );
    break;
default:
