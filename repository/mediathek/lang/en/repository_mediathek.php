...
$string['cachecleared'] = 'Mediathek search parameter cache cleared';
...
$string['configplugin'] = 'Configure Mediathek plugin';
...
$string['mediathek:view'] = 'View Mediathek repository';
$string['mediatype'] = 'Media type';
$string['password'] = 'Mediathek server password';
$string['pluginname'] = 'Mediathek';
