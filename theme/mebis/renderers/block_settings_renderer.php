...
/**
 * Overriding the settings block renderer of parent theme bootstrap
 *
 * @package   theme_mebis
...
require_once($CFG->dirroot . "/theme/bootstrap/renderers/block_settings_renderer.php");

class theme_mebis_block_settings_renderer extends theme_bootstrap_block_settings_renderer {
