 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_dlbnavi_edit_form extends block_edit_form {
    /**
    ...
    protected function specific_definition($mform) {
        ...
        $options = array(
            block_dlbnavi::TRIM_RIGHT => get_string('trimmoderight', $this->block->blockname),
            block_dlbnavi::TRIM_LEFT => get_string('trimmodeleft', $this->block->blockname),
            block_dlbnavi::TRIM_CENTER => get_string('trimmodecenter', $this->block->blockname)
        );
