...
/**
 * Renderer for block_mbs_schooltitle
 *
...
class block_mbs_schooltitle_renderer extends plugin_renderer_base {
    ...
    public function render_content($titledata) {
        ...
        if (!empty($titledata->imageurl)) {
            $imagetag = html_writer::empty_tag('img', array('src' => $titledata->imageurl, 'alt' => get_string('imageofcategory', 'block_mbs_schooltitle')));
