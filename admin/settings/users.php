...
if ($hassiteconfig
 ...
 or has_capability('moodle/cohort:view', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    //+++ awag DS16: verbirgt die Bulk verwaltung für User, die nicht das Recht haben über Schulgrenzen hinaus zu sehen*/
    ...
    \block_dlb\local\datenschutz::hook_admin_users_hide_bulk($ADMIN);
    //---
