...
class questeditform extends \moodleform {
    function definition() {
        ...
        $form->addElement('text', 'name', get_string('questionname', 'block_mbstemplating'), 'maxlength="250" size="25"');
        $form->addRule('name', $strrequired, 'required', null, 'client');
        $form->setType('name', PARAM_TEXT);

        $form->addElement('textarea', 'title', get_string('questiontitle', 'block_mbstemplating'), array('rows' => 3, 'cols' => 70, 'class' => 'smalltext'));
