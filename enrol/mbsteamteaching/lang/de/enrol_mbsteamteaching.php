...
/**
 * Strings for component 'enrol_self', language 'de', branch 'MOODLE_27_STABLE'
 *
 * @package   enrol_self
...
$string['pluginname'] = 'mebis Team Teaching';
$string['pluginname_desc'] = 'Das Plugin \'mebis Team Teaching\' ist einer modifizierte Kopie der Selbsteinschreibung und erlaubt Nutzer/innen zu wählen, in welchen Kursen sie als Lehrer teilnehmen möchten. Die Kurse können mit einem Einschreibeschlüssel gesichert sein. Intern wird die Selbsteinschreibung über das Plugin \'Manuelle Einschreibung\' abgewickelt, welches im Kurs notwendigerweise ebenfalls aktiviert sein muss.';
