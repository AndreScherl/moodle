...
YUI.add('moodle-core_filepicker', function(Y) {
    ...
    Y.Node.prototype.fp_display_filelist = function(options, fileslist, lazyloading) {
        ...
        var build_tree = function(node, level) {
            ...
            el.one('a').appendChild(file_get_tooltip(node)); // SYNERGY LEARNING - add tooltip to file icon.
            // create node
        ...
        var formatTitle = function(o) {
            ...
            el.one('a').appendChild(file_get_tooltip(o.data)); // SYNERGY LEARNING - add tooltip to file icon.
            if (options.rightclickcallback) {
        ...
        var append_files_icons = function() {
            ...
            for (var k in fileslist) {
                ...
                element.appendChild(file_get_tooltip(node)); // SYNERGY LEARNING - add tooltip to file icon.
            }
        }
