YUI.add('moodle-block_dlbnavi-navigation', function(Y){
...
TREE.prototype = {
    ...
    initializer : function(config) {
        ...
        for (var i in expansions) {
            ...
            M.block_dlbnavi.expandablebranchcount++;
        }
...
BRANCH.prototype = {
    ...
    ajaxProcessResponse : function(tid, outcome) {
        ...
        try {
            ...
            if (object.children && object.children.length > 0) {
                ...
                if (this.get('type') == 10 && coursecount >= M.block_dlbnavi.courselimit) {
    ...
    addChild : function(branchobj) {
        ...
        if (branch.draw(this.getChildrenUL())) {
            ...
            if (branch.get('type') == 10 && count >= M.block_dlbnavi.courselimit) {
...
Y.extend(BRANCH, Y.Base, BRANCH.prototype, {
    ...
    ATTRS : {
        ...
        id : {
            ...
            getter : function(val) {
                if (val == '') {
                    val = 'expandable_branch_'+M.block_dlbnavi.expandablebranchcount;
                    M.block_dlbnavi.expandablebranchcount++;
                }
                return val;
            }
 ...
 * @namespace
 */
M.block_dlbnavi = M.block_dlbnavi || {
