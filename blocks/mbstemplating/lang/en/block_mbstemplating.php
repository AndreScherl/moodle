...
$string['mbstemplating:coursetemplatemanager'] = 'Course template manager';
$string['mbstemplating:coursetemplatereview'] = 'Course template review';
$string['mbstemplating:createcoursefromtemplate'] = 'Create course from template';
$string['mbstemplating:myaddinstance'] = 'Add a my course template information block instance to My Home';
$string['mbstemplating:ratetemplate'] = 'Rate template';
$string['mbstemplating:sendcoursetemplate'] = 'Send course template';
$string['mbstemplating:viewcoursetemplatebackups'] = 'View course template backups';
