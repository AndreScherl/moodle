...
/**
 * The mod_choiceanon answer updated event.
 *
...
/**
 * The mod_choiceanon answer updated event class.
 *
...
class answer_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated their choiceanon with id '$this->objectid' in the choiceanon activity
    ...
    public static function get_name() {
        return get_string('eventanswerupdated', 'mod_choiceanon');
    }
