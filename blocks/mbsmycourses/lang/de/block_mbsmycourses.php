...
/**
 * Strings for component 'block_course_overview', language 'de', branch 'MOODLE_27_STABLE'
 *
...
$string['hiddencoursecount'] = 'Sie haben {$a} verborgenen Kurs';
...
$string['fullname'] = 'Kursname';
$string['grid'] = 'Kachelansicht';
$string['lastaccess'] = 'Letzter Zugriff';
$string['list'] = 'Listenansicht';
$string['manual'] = 'Eigene Sortierung';
$string['movecategory'] = 'Sie verschieben: {$a->fullname} ({$a->cancellink})';
$string['movecatafterhere'] = 'Verschiebe {$a->movingcategoryname} Bereich hinter {$a->currentcategoryname}';
$string['new'] = 'NEU';
