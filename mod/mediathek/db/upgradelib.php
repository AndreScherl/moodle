...
/**
 * mediathek module upgrade related helper functions
 *
 * @package    mod
...
/**
 * Migrate mediathek module data from 1.9 resource_old table to new url table
 * @return void
 */
function url_20_migrate() {
    ...
    foreach ($candidates as $candidate) {
        ...
        if (!$url = resource_migrate_to_module('mediathek', $candidate, $url)) {
            continue;
        }
    }
