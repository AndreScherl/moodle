...
/**
 * Strings for component 'choiceanon', language 'de', branch 'MOODLE_24_STABLE'
 *
 * @package   choiceanon
...
$string['addmorechoiceanons'] = 'Optionen hinzufügen';
...
$string['choiceanon'] = 'Abstimmung Anonym';
$string['choiceanon:addinstance'] = 'Neue Abstimmung hinzufügen';
$string['choiceanon:choose'] = 'Abstimmung vornehmen';
$string['choiceanonclose'] = 'bis';
$string['choiceanon:deleteresponses'] = 'Stimmabgaben löschen';
$string['choiceanon:downloadresponses'] = 'Stimmabgaben herunterladen';
$string['choiceanonfull'] = 'Diese Option ist voll und es sind keine Plätze mehr verfügbar.';
$string['choiceanonname'] = 'Abstimmungsname';
$string['choiceanonopen'] = 'von';
$string['choiceanonoptions'] = 'Abstimmoptionen';
$string['choiceanonoptions_help'] = 'Tragen Sie hier die Abstimmoptionen ein, zwischen denen sich die Teilnehmer/innen entscheiden sollen.
...
$string['choiceanon:readresponses'] = 'Stimmabgaben sehen';
$string['choiceanonsaved'] = 'Ihre Auswahl wurde gespeichert';
$string['choiceanontext'] = 'Abstimmungstext';
...
$string['modulename'] = 'Abstimmung Anonym';
...
$string['page-mod-choiceanon-x'] = 'Jede Abstimmungsseite';
$string['pluginadministration'] = 'Abstimmungsadministration';
$string['pluginname'] = 'Abstimmung Anonym';
...
$string['removemychoiceanon'] = 'Meine Auswahl löschen';
...
$string['savemychoiceanon'] = 'Meine Auswahl speichern';
