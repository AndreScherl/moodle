...
/**
 * mbstplaenrl enrolment plugin - support for user mbstplaenrl unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'mbstplaenrl'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/mbstplaenrl/unenrolself.php', array('enrolid'=>$instance->id));
