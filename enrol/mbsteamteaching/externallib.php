...
/**
 * mbsteamteaching enrol plugin external functions
 *
...
/**
 * mbsteamteaching enrolment external functions.
 *
 * @package   enrol_mbsteamteaching
 ...
 * @since     Moodle 2.6
 */
class enrol_mbsteamteaching_external extends external_api {
    ...
    public static function get_instance_info_parameters() {
        return new external_function_parameters(
                array('instanceid' => new external_value(PARAM_INT, 'instance id of mbsteamteaching enrolment plugin.'))
            );
    }

    /**
     * Return mbsteamteaching-enrolment instance information.
     *
     * @param int $instanceid instance id of mbsteamteaching enrolment plugin.
    ...
    public static function get_instance_info($instanceid) {
        ...
        // Retrieve mbsteamteaching enrolment plugin.
        $enrolplugin = enrol_get_plugin('mbsteamteaching');
