...
/**
 * Lang strings for mbs_my_courses block
 *
...
$string['mbs_my_courses:addinstance'] = 'Add a new course overview block';
$string['mbs_my_courses:myaddinstance'] = 'Add a new course overview block to My home';
