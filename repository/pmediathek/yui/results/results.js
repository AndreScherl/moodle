...
YUI.add('moodle-repository_pmediathek-results', function(Y) {
   "use strict";
    ...
    M.repository_pmediathek.results = {
        init: function() {
            Y.one('#page-content').delegate('click', function(e) { this.toggle_result(e.currentTarget); }, '.resultheading', this);
            Y.one('#page-content').delegate('click', this.insert_result, '.insertlink', this);
        },
