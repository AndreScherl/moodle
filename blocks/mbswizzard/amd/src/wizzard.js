...
require.config({
    paths: {
        'jquery.scrollTo': M.cfg.wwwroot+'/blocks/mbswizzard/js/scrollTo/jquery.scrollTo.min-2.1.0'
...
define('mbswizzard', ['jquery', 'jqueryui'], function($){
    var sequence = {
        name: null,
        current_step: 0,
        steps: []
     ...
     */
    var copy_sequence_from_json = function(sname, callback) {
     ...
     */
    var get_sequence = function(sname) {
     ...
     */
    var store_sequence = function(seq) {
     ...
     */
    var prepare_next_step = function(cstep) { 
     ...
     */
    var set_wizzard_state = function(state, sequence) {
        $.ajax({
     ...
     */
    var prepare_finish_sequence = function(state) {
     ...
     * @param string $state - finish or cancel
     */
    var finish_sequence = function(state) {
