...
$string['sequence_course_setup_help'] = 'Organize Learning: Add students to your course and edit a headline.';
$string['sequence_first_learningsequence'] = 'Design Learning';
$string['sequence_first_learningsequence_help'] = 'Design Learning: Create your first little learning sequence to use in class.';
$string['step'] = 'Step';
