...
class repository_mediathek extends repository {
            ...
            foreach ($results as $result) {
                ...
                if ($okformat) {
                    ...
                    $tooltipinfo .= '<b>'.get_string('resourcetype', 'repository_mediathek').'</b>: '.
                        self::get_resource_typename($result->educational_resourcetype).'<br />';
                    if (!empty($result->rights_license)) {
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        $clearcache = html_writer::link($clearcacheurl, get_string('clearcache', 'repository_mediathek'),
                                        array('target' => '_blank'));
    ...
    protected static function get_resource_typename($type) {
        $api = self::get_api();
