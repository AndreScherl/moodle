...
/**
 * block_mbs_newcourse course request page
 * 
...
require_once($CFG->dirroot.'/blocks/mbs_newcourse/mbs_request_form.php');
require_once($CFG->dirroot.'/lib/coursecatlib.php');

// ...shortening the namespace of automatic loaded class.
use block_mbs_newcourse\local\mbs_course_request as mbs_course_request;
...
$url = new moodle_url('/blocks/mbs_new_course/request.php', array('category' => $category->id));
$PAGE->set_url($url);
