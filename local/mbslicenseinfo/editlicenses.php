...
$thisurl = new moodle_url('/local/mbslicenseinfo/editlicenses.php', array('course' => $course));
$PAGE->set_url($thisurl);
$PAGE->set_pagelayout('incourse');
$PAGE->set_context($coursecontext);

if (!has_capability('local/mbslicenseinfo:editlicenses', $coursecontext)) {
    throw new moodle_exception('errorcannotedit', 'local_mbslicenseinfo');
}
...
$pagenode = $coursenode->add(get_string('editlicenses', 'local_mbslicenseinfo'));
$pagenode->make_active();

$pagetitle = get_string('editlicensesdescr', 'local_mbslicenseinfo');
$PAGE->set_title($pagetitle);

$form = new \local_mbslicenseinfo\form\editlicensesform(null, array('course' => $course, 'page' => $page, 'perpage' => $perpage));
...
$totalcount = \local_mbslicenseinfo\local\mbslicenseinfo::get_number_of_course_files($course);
if (get_config('local_mbslicenseinfo', 'filesperpage') != $perpage) {
