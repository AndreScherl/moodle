...
$url = new moodle_url('/blocks/mbs_search/ajax.php');
$PAGE->set_url($url);
...
switch ($action) {
    ...
    case 'blockschoolsearch':
        ...
        $resp = array('error' => 0, 'results' => \block_mbs_search\local\mbs_search::lookup_search($searchtext, $config->lookupcount, $schoolcatid));
    ...
    case 'loadmoreresults':
        ...
        $results = \block_mbs_search\local\mbs_search::search($searchtext, $limitfrom, $limitnum, $filterby);

        $renderer = $PAGE->get_renderer('block_mbs_search');
    ...
    default:
        ...
        print_error('unknownaction', 'block_mbs_search');
        die();
}
