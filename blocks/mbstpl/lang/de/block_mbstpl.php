...
$string['addassets'] = 'Fügen Sie {no} Inhalte hinzu';
...
$string['assets'] = 'Inhalte von Drittanbietern genutzt';
...
$string['license'] = 'Veröffentlichen unter der Lizenz';
...
$string['mypublished'] = 'Kurse im Reviewingprozess';
$string['myreview'] = 'Meine Kurse in Bearbeitung';
$string['myrevision'] = 'Kurse im Reviewingprozess';
...
$string['owner'] = 'Name des Besitzers';
...
$string['sendfeedbacktoauthor'] = 'Nachricht und Bearbeitungsrecht an Autor';
$string['sendfeedbacktoreviewer'] = 'Nachricht und Bearbeitungsrecht an Autor';
...
$string['source'] = 'Name der Ursprungsdatei';
$string['sourcesblock:title'] = 'Genutzte Dateien';
$string['statusarchived'] = 'Archiviert';
$string['statuscreated'] = 'Erstellt';
$string['statuspublished'] = 'Veröffentlicht';
$string['statusunderreview'] = 'Bearbeitung durch Autor';
$string['statusunderrevision'] = 'Bearbeitung durch Reviewer';
...
$string['tplremindafter_desc'] = 'Jeder Nutzer, der das Recht Master Reviwer im System-Kontext hat, wird benachrichtigt, wenn ein Kurs nicht in der vorgegebenen Zeit bearbeitet wird.';
$string['tplremindersent'] = 'Erinnerung abgeschickt.';
$string['updated'] = 'Zeit';
$string['uploadfile'] = 'Datei hochladen';
$string['url'] = 'URL der Webseite';
$string['useq'] = 'Diese Frage nutzen';
$string['usedref'] = '{$a->link} von {$a->owner}';
