...
/**
 * Strings for component 'choiceanon', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   choiceanon
...
$string['addmorechoiceanons'] = 'Add more choices';
...
$string['choiceanon'] = 'Choice anonymous';
$string['choiceanon:addinstance'] = 'Add a new choice';
$string['choiceanonclose'] = 'Until';
$string['choiceanon:deleteresponses'] = 'Delete responses';
$string['choiceanon:downloadresponses'] = 'Download responses';
$string['choiceanonfull'] = 'This choice is full and there are no available places.';
$string['choiceanon:choose'] = 'Record a choice';
$string['choiceanonname'] = 'Choice name';
$string['choiceanonopen'] = 'Open';
$string['choiceanonoptions'] = 'Choice options';
$string['choiceanonoptions_help'] = 'Here is where you specify the options that participants have to choose from.
...
$string['choiceanon:readresponses'] = 'Read responses';
$string['choiceanonsaved'] = 'Your choice has been saved';
$string['choiceanontext'] = 'Choice text';
$string['chooseaction'] = 'Choose an action ...';
$string['limit'] = 'Limit';
$string['limitanswers'] = 'Limit the number of responses allowed';
$string['modulename'] = 'Choice anonymous';
...
$string['modulename_link'] = 'mod/choiceanon/view';
$string['modulenameplural'] = 'choiceanons';
...
$string['page-mod-choiceanon-x'] = 'Any choiceanon module page';
$string['pluginadministration'] = 'Choiceanon administration';
$string['pluginname'] = 'Choice Anonymous';
