...
$string[ 'bookquiz_import_odt'] = 'OpenOffice-Datei (odt) hinzufügen';
$string[ 'bookquiz_not_select_book'] = 'Sie haben kein Buch ausgewählt';
...
$string[ 'cross_error'] = 'Falscher Buchstabe';
...
$string[ 'cross_checkbutton'] = 'Rätsel prüfen';
$string[ 'cross_down'] = 'Senkrecht';
$string[ 'cross_endofgamebutton'] = 'Spiel beenden';
$string[ 'cross_error_containsbadchars'] = 'Dieses Wort beinhaltet nicht erlaubte Zeichen';
$string[ 'cross_error_wordlength1'] = 'Das richtige Wort beinhaltet ';
$string[ 'cross_error_wordlength2'] = ' Buchstaben.';
$string[ 'cross_pleasewait'] = 'Bitte warten Sie, solange das Rätsel geladen wird';
$string[ 'cross_welcome'] = '<h3>Willkommen!</h3><p>Klicken Sie auf ein Wort, um anzufangen/weiterzumachen.</p>';
$string[ 'letter'] = 'Buchstabe';
$string[ 'letters'] = 'Buchstaben';
$string[ 'nextgame'] = 'Neues Spiel';
$string[ 'no_words'] = 'Keine Wörter angegeben';
...
//db/access.php
$string[ 'game:attempt'] = 'Spielen';
$string[ 'game:deleteattempts'] = 'Versuche löschen';
$string[ 'game:grade'] = 'Spiele manuell bewerten';
$string[ 'game:manage'] = 'Verwalten';
$string[ 'game:manageoverrides'] = 'Spieloptionen verwalten';
$string[ 'game:preview'] = 'Spielevorschau';
$string[ 'game:reviewmyattempts'] = 'Erneut versuchen';
...
$string[ 'hangman_restletters_one'] = 'Sie haben <b>nur noch 1</b> Versuch!';
...
$string[ 'must_select_glossary'] = 'Sie müssen ein Glossar auswählen';
$string[ 'no_questions'] =' Es sind keine Fragen vorhanden';
$string[ 'noglossaryentriesfound'] = 'Keine Einträge im Wörterbuch gefunden';

//millionaire/play.php
$string[ 'millionaire_must_select_questioncategory'] = 'Sie müssen eine Fragenkategorie wählen';
...
$string[ 'javame_maxpictureheight'] = 'Maximale Bildhöhe:';
$string[ 'javame_maxpicturewidth'] = 'Maximale Bildbreite:';
...
$string[ 'must_select_quiz'] = 'Sie müssen ein Quiz wählen';

//exporthtml_snakes.php
$string[ 'html_snakes_check'] = 'Bitte auswählen';
...
$string['modulename_help'] = 'Dieses Modul enthält 8 Spiele: Galgenmännchen, Kreuzworträtsel, Suchrätsel, Wer wird Millionär, Sudoku, Schlangen und Leitern, Verstecktes Bild und Buch mit Fragen';
...
$string[ 'bookquiz_options'] = 'Buchspiel-Optionen';
...
$string[ 'cross_maxcols'] = 'Maximale Anzahl an Spalten/Zeilen des Kreuzworträtsels';
$string[ 'cross_max_attempts'] = 'Maximale Anzahl der Versuche';
$string[ 'cross_maxwords'] = 'Maximale Anzahl von Wörtern des Kreuzworträtsels';
$string[ 'cross_minwords'] = 'Minimale Anzahl von Wörtern des Kreuzworträtsels';
$string[ 'cross_options'] = 'Kreuzworträtsel-Optionen';
$string[ 'cryptex_maxtries'] = 'Maximale Anzahl der Versuche';
$string[ 'cryptex_options'] = 'Suchrätsel-Optionen';
$string[ 'gameclose'] = 'Spiel schließen';
$string[ 'gameopen'] = 'Spiel öffnen';
$string[ 'gameopenclose'] = 'Anfangs- und Endzeitpunkt des Spiels';
$string[ 'gameopenclose_help'] = 'Schüler können ihre Spielversuche nach dem Anfangszeitpunkt starten und müssen sie vor dem Endzeitpunkt beenden.';
$string[ 'grademethod'] = 'Bewertungsmethode';
$string[ 'hangman_allowspaces'] = 'Wortzwischenräume erlauben';
$string[ 'hangman_allowsub'] = 'Bindestrich in Wörtern erlauben';
$string[ 'hangman_imageset'] = 'Bild für Galgenmännchen wählen';
$string[ 'hangman_language'] = 'Sprache';
...
$string[ 'hangman_maxtries'] = 'Anzahl der Wörter pro Spiel';
...
$string[ 'hiddenpicture_height'] = 'Höhe des Bilds festlegen';
$string[ 'hiddenpicture_options'] = 'Optionen für Verstecktes Bild';
$string[ 'hiddenpicture_pictureglossary'] = 'Wörterbuch für Hauptfrage und Bild';
$string[ 'hiddenpicture_width'] = 'Breite des Bilds festlegen';
$string[ 'millionaire_background'] = 'Hintergrundfarbe';
$string[ 'millionaire_options'] = 'Optionen für \'Wer wird Millionär\'';
...
$string[ 'snakes_options'] = 'Optionen für \'Schlangen und Leitern\'';
$string[ 'snakes_rows'] = 'Zeilen';
...
//preview.php
$string[ 'only_teachers'] = 'Nur Lehrer/in kann diese Seite sehen';
...
$string[ 'reviewofattempt'] = 'Überprüfung von Versuch {$a}';
...
$string[ 'feedbacks'] = 'Meldungen bei richtiger Antwort';
...
$string[ 'gameclosed'] = 'Dieses Spiel endete am {$a}';
...
$string[ 'reattemptgame'] = 'Noch einmal spielen';
$string[ 'yourfinalgradeis'] = 'Ihre Endbewertung für dieses Spiel ist {$a}.';

$string['headerfooteroptions'] ='Optionen für Kopf- und Fußzeile';
