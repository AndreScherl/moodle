...
$string['noresults'] = 'Zu Ihrer Eingabe wurden keine Ergebnisse gefunden, bitte probieren Sie es mit anderen Suchbegriffen.';
$string['numoftotal'] = 'Ergebnisse: {$a->displaystart} bis {$a->displayend} von {$a->total}';
...
$string['searchonlyin'] = 'nur in {$a} suchen';
$string['searchschoolandcourse'] = 'Kurs und Schule suchen';
