...
class editheader_form extends moodleform {
    ...
    function definition_after_data() {
        ...
        if ($catdata) {
            ...
            $context = context_coursecat::instance($catdata->categoryid, MUST_EXIST);
...
if ($custom_catdata) {
    $mform->set_data($custom_catdata);
}

$redir = new moodle_url('/course/management.php', array('categoryid' => $categoryid));
