...
define(['jquery', 'theme_bootstrap/bootstrap', 'jquery.scrollTo'], function($){
    ...
    var mbswizzard = {
         ...
         */
        copy_sequence_from_json: function(sname, callback) {
         ...
         */
        prepare_next_step: function(cstep) { 
            ...
            if (this.sequence.steps[cstep].actionsel !== null) {
                ...
                $(this.sequence.steps[cstep].sel).on('click', $.proxy(function() {
                    this.sequence.current_step = cstep+1;
                    this.store_sequence(this.sequence);
                }, this)); 
            }
         ...
         */
        set_wizzard_state: function(state, sequence) {
            $.ajax({
         ...
         */
        prepare_finish_sequence: function(state) {
         ...
         * @param string $state - finish or cancel
         */
        finish_sequence: function(state) {
