...
/**
 * Renderer for Block mbs_coordinators
 *
...
class block_mbs_coordinators_renderer extends plugin_renderer_base {
    ...
    public function render_coordinators($coordinators) {
        ...
        $out = html_writer::tag('div', get_string('mebiscoordinators', 'block_mbs_coordinators')).': ';

        foreach ($coordinators as $coordinator) {

            $messageurl = new moodle_url('/message/index.php', array('id' => $coordinator->id));
            $messageicon = $OUTPUT->pix_icon('t/email', get_string('sendmessage', 'block_mbs_coordinators'));
        ...
        return html_writer::tag('div', $out, array('class' => 'mbs_coordinators'));
    }
