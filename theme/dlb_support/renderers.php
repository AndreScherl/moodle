...
class theme_dlb_support_core_renderer extends core_renderer {
    ...
    public function navbar() {
        ...
        //falls der zweite Breadcrumb home ist, ersten entfernen
        if (isset($items[1]) and ($items[1]->key == 'home')) {
            ...
            //+++ Falls der erste Breadcrumb "Meine Startseite" ist, ersetzen
            if ($items[0]->key == 'myhome') {
                $properties = array(
                        'key' => 'home',
            ...
            //Auf der Mymoodle-Page meine Starteite anhängen
    ...
    function generalheader() {
        ...
        $strhome = "";
        //$content = html_writer::link("", $headerleft, array("alt"=>$strhome, "title" => $strhome));
         $content = html_writer::tag('div', $headerleft, array("alt"=>$strhome, "title" => $strhome));
        //header-right
...
*/
    ...
    function _load_dock_images() {
        ...
        $dock_images = array("activity_modules", "admin_bookmarks", "blog_menu", "blog_recent",
                ...
                "completionstatus",  "course_list", "course_overview", "course_summary",
                "feedback", "glossary_random", "html", "login", "mentees", "messages", "mnet_hosts",
                "myprofile", "navigation", "news_items" , "online_users", "participants",
                "private_files", "quiz_results", "recent_activity", "rss_client",
