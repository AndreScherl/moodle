YUI.add('moodle-block_mbssearch-blocksearch', function (Y, NAME) {

M.block_mbssearch = M.block_mbssearch || {};
M.block_mbssearch.blocksearch = {

    init: function(opts) {

        var searchbox, resultel, schoolcatidbox;

        searchbox = Y.one('#mbssearch_form #searchtext');
        schoolcatidbox = Y.one('#mbssearch_form #search_schoolcatid');
