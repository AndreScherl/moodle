YUI.add('moodle-block_meineschulen-courseoverview', function (Y, NAME) {

/*global M*/
M.block_meineschulen = M.block_meineschulen || {};
M.block_meineschulen.courseoverview = {
    init: function(opts) {
        var base, sel;
        ...
        sel.on('change', function(e) {
            ...
            if (selected.match(/courseoverview=standard/)) { // Standard selected.
                M.util.set_user_preference('meineschulen_courseoverview', 'standard');
                ...
                M.util.set_user_preference('meineschulen_courseoverview', 'treeview');
