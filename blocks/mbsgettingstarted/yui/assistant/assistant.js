 ...
 *
 * @package	DLB - block: mbsgettingstarted
 * @author	Andre Scherl
 *
...
YUI.add('moodle-block_mbsgettingstarted-assistant', function(Y) {
	// Define a name space to call
	M.block_mbsgettingstarted = {};
	
	M.block_mbsgettingstarted.assistant = {  
    	sequence: {
	    	name: null,
	    	current_step: 0,
	    	steps: []	
	...
	M.block_mbsgettingstarted.assistant.init = function() {
		...
		Y.all('.block_mbsgettingstarted .link_assistant').on('click', Y.bind(function(e){
	 ...
	 */
	M.block_mbsgettingstarted.assistant.copy_sequence_from_json = function(sname, callback) {
		Y.io(M.cfg['wwwroot']+"/blocks/mbsgettingstarted/yui/assistant/sequence_"+sname+".json", {
		    	on: {
	 ...
	 */
	M.block_mbsgettingstarted.assistant.get_sequence = function(sname) {
	 ...
	 */
	M.block_mbsgettingstarted.assistant.store_sequence = function(seq) {
	 ...
	 * @param number step
	 */
	M.block_mbsgettingstarted.assistant.show_tip = function(step) {
	 ...
	 */
	M.block_mbsgettingstarted.assistant.prepare_next_step = function(cs) {
